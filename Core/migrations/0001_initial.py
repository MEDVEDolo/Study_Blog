    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ManyToManyField(null=True, related_name='posts', to='Core.tag')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('subscriptions', models.ManyToManyField(blank=True, null=True, related_name='subs', to=settings.AUTH_USER_MODEL)),
